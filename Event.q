...
addEvent:{[d] nr:.z.d+d`time;if[d[`time]<=.z.t;nr:nr+1D];event::event upsert (d`name;d`time;d`fun;d`st;d`et;0Np;nr)}
...
value"\\t 100";
show "Hello";
addEvent[`name`time`fun`st`et!(`event1;.z.t-00:01:05;{show "Hello Event";10+10};.z.P;0Wp)];
